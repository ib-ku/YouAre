...
const file_user_proto_rawDesc = "" +
	...
	"\x05users\x18\x01 \x03(\v2\x12.user.UserResponseR\x05users2\xe1\x02\n" +
	"\vUserService\x125\n" +
...
var file_user_proto_depIdxs = []int32{
	4, // 0: user.LoginResponse.user:type_name -> user.UserResponse
	4, // 1: user.UserListResponse.users:type_name -> user.UserResponse
	...
	3, // 5: user.UserService.GetProfile:input_type -> user.ProfileRequest
	7, // 6: user.UserService.GetAllProfiles:input_type -> google.protobuf.Empty
	3, // 7: user.UserService.DeleteUser:input_type -> user.ProfileRequest
	4, // 8: user.UserService.Register:output_type -> user.UserResponse
	5, // 9: user.UserService.Login:output_type -> user.LoginResponse
	4, // 10: user.UserService.GetUser:output_type -> user.UserResponse
	4, // 11: user.UserService.GetProfile:output_type -> user.UserResponse
	6, // 12: user.UserService.GetAllProfiles:output_type -> user.UserListResponse
